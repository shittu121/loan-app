...
export const HeroSection2 = () => {
  return (
    <div className="text-black flex justify-center items-center min-h-screen px-4">
      <div className="text-center">
        <h2 className="text-xl md:text-2xl lg:text-4xl font-bold">
          Find Loan Products We Offer
        </h2>
        <p className="mt-4 text-lg md:text-xl max-w-sm lg:max-w-2xl mx-auto text-gray-800">
